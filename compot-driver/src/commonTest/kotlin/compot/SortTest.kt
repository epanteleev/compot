...
abstract class SortTest: CommonCTest() {
    ...
    fun testInsertionSort() {
        val result = runCTest("compot/sort/insertionSort", listOf("runtime/runtime.c"), options())
        assert(result, "11 12 22 25 34 64 \n")
    }

    @Test
    fun testBubbleSort() {
        val result = runCTest("compot/sort/bubble_sort_int", listOf("runtime/runtime.c"), options())
        assert(result, "11 12 22 25 34 64 \n")
    }

    @Test
    fun testQuickSort() {
        val result = runCTest("compot/sort/quickSort", listOf(), options())
    ...
    @Test
    fun testHeapSort() {
        val result = runCTest("compot/sort/heap_sort", listOf(), options())
