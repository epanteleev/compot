 ...
 *
 *  Modified   :   6 Mar 21 /cjw
 *             :   Split up Variable- & Set key tests
 *             :   Removed test of invalid 1-3 byte keys
 */
...
BFISH_U32 ciphertext_sl[NUM_SET_KEY_TESTS] = {
   ...
   0xAFD5AED1l, 0x10851C0El, 0xE6F51ED7l, 0x64A6E14Al, 0x80C7D7D4l,
   0x05044B62l };
...
BFISH_U32 ciphertext_sr[NUM_SET_KEY_TESTS] = {
   ...
   0xC1BC96A8l, 0x3858DA9Fl, 0x9B9DB21Fl, 0xFD36B46Fl, 0x5A5479ADl,
   0xFA52D080l };
