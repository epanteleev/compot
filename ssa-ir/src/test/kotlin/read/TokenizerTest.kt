...
class TokenizerTest {
    ...
    fun oneLineTest() {
        ...
        assertEquals(ValueToken("1", 1, 17), iterator.next())
    ...
    fun severalLinesTest() {
        ...
        assertEquals(ValueToken("3", 1, 0), iterator.next())
        ...
        assertTrue(iterator.hasNext())
        assertEquals(ValueToken("129", 1, 13), iterator.next())
        assertTrue(iterator.hasNext())
        assertEquals(Comma(1, 17), iterator.next())
        assertTrue(iterator.hasNext())
        assertEquals(ValueToken("1", 1, 19), iterator.next())
        assertTrue(iterator.hasNext())
        assertEquals(ValueToken("43", 2, 0), iterator.next())
        assertTrue(iterator.hasNext())
