...
{
    // empty array
    int64_t arr_empty[1] = { 0 };
    assert(exponential_search(arr_empty, 0, 10) == -1);
    // elent not found
    int64_t arr_found[3] = {1, 2, 3};
