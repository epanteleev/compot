...
sourcefiles="safezone.c umka_expr.c umka_const.c umka_ident.c umka_common.c umka_decl.c umka_compiler.c umka_stmt.c umka_lexer.c umka_gen.c "

sourcefiles_gcc="umka_runtime.c umka_types.c umka_vm.c  umka_api.c"
