...
abstract class InitializerListTest: CommonCTest() {
    ...
    @Test
    fun test11() {
        val result = runCTest("shlang/initializerList/initializerList11", listOf(), options())
    ...
    @Test
    fun test12() {
        val result = runCTest("shlang/initializerList/initializerList12", listOf(), options())
        assertEquals("0 0", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    @Test
    fun test13() {
        val result = runCTest("shlang/initializerList/initializerList13", listOf(), options())
        assertEquals("text1: \n", result.output)
        assertEquals(0, result.exitCode)
    }
