...
abstract class CListTest: CommonCTest()  {
    ...
    @Test
    fun testListChar() {
        val opt = options() + "-Isrc/resources/shlang/list" + "-DDATATYPE=char" + "-DFMT='\"%hhd\\n\"'"
        val result = runCTest("shlang/list/listTest0", listOf(), opt)
        assertEquals("1\n-2\n-3\n4\n5\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    fun testListLong1() {
        val opt = options() + "-Isrc/resources/shlang/list" + "-DDATATYPE=long" + "-DFMT='\"%ld\\n\"'"
        val result = runCTest("shlang/list/listTest1", listOf(), opt)
        assertEquals("2\n4\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    fun testListUnsignedInt1() {
        val opt = options() + "-Isrc/resources/shlang/list" + "-DDATATYPE='unsigned int'" + "-DFMT='\"%u\\n\"'"
        val result = runCTest("shlang/list/listTest1", listOf(), opt)
        assertEquals("2\n4\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    fun testListUnsignedLong1() {
        val opt = options() + "-Isrc/resources/shlang/list" + "-DDATATYPE='unsigned long'" + "-DFMT='\"%lu\\n\"'"
        val result = runCTest("shlang/list/listTest1", listOf(), opt)
        assertEquals("2\n4\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    fun testListUnsignedChar1() {
        val opt = options() + "-Isrc/resources/shlang/list" + "-DDATATYPE='unsigned short'" + "-DFMT='\"%hu\\n\"'"
        val result = runCTest("shlang/list/listTest1", listOf(), opt)
        assertEquals("2\n4\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    fun testListUnsignedShort1() {
        val opt = options() + "-Isrc/resources/shlang/list" + "-DDATATYPE='unsigned char'" + "-DFMT='\"%hhu\\n\"'"
        val result = runCTest("shlang/list/listTest1", listOf(), opt)
        assertEquals("2\n4\n", result.output)
        assertEquals(0, result.exitCode)
    }
