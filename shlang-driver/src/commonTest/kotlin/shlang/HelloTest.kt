...
abstract class HelloTests: CommonCTest() {
    ...
    @Test
    fun testHelloWorld8() {
        val result = runCTest("shlang/hello_world/hello_world8", listOf(), options())
        assertEquals("\"Hello, World!\"\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    @Test
    fun testHelloWorld9() {
        val result = runCTest("shlang/hello_world/hello_world9", listOf(), options())
        assertEquals("Hello, World!\n", result.output)
        assertEquals(0, result.exitCode)
    }
    ...
    fun testHelloWorld10() {
        val result = runCTest("shlang/hello_world/hello_world10", listOf(), options())
