...
class CFunctionModuleBuilder(private val moduleBuilder: CModuleBuilder,
    ...
    companion object {
        fun create(moduleBuilder: CModuleBuilder, prototype: FunctionPrototype, argumentValueTokens: List<String>): CFunctionModuleBuilder {
            ...
            return CFunctionModuleBuilder(moduleBuilder, prototype, arguments, basicBlocks, nameMap)
        }
    }
}